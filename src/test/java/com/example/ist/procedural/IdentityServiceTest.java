...
@SpringBootTest(classes = {IdentityService.class, InMemoryUserRepository.class})
...
public class IdentityServiceTest {
    ...
    @Before
    public void setUp() {
        userRepository.updatePassword(UUID.fromString(TEST_USER_ID), new Password("Passw0rd"));
    }
    @Theory
    public void testChangePasswordWithPolicySatisifedPassword(@FromDataPoints("policySatisfiedPasswords") String fixture) throws Exception {
        ...
        try {
            ...
            // verify
            User actual = userRepository.userFromId(UUID.fromString(TEST_USER_ID));
